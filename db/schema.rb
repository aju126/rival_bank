...
ActiveRecord::Schema.define(version: 20171209104234) do
  ...
  create_table "transactions", force: :cascade do |t|
    t.integer  "source_user_account_id",      limit: 4
    t.integer  "destination_user_account_id", limit: 4
  ...
  add_index "transactions", ["destination_user_account_id"], name: "index_transactions_on_destination_user_account_id", using: :btree
