ActiveAdmin.setup do |config|
  ...
  config.authentication_method = false #authenticate_admin_user_account!
  ...
  config.current_user_method = :current_user_account
  ...
  #
  # Default:
  config.logout_link_path = :destroy_user_account_session_path
